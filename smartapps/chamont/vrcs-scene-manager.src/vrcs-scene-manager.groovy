 ...
 *
 * 	VRCS Button Controller
 *
 * 	Author: Monty Charlton, based on Brian Dahlem's VRCS Button Controller
 */
definition(
...
def buttonEvent(evt) {
    ...
    if (allOk) {
        ...
        def recentEvents = buttonDevice.eventsSince(new Date(now() - 3000)).findAll {
